...
データの事実（「CTR 0.10%」「pos 9.5」等）は淡々と書いてOK。
それに対する**価値判断**を中立に表現する、ということ。

例：
- ❌ company.html の就職困難者の記述に誤りがある
- ✅ company.html の就職困難者まわりを2025年最新版に更新

- ❌ parttime.html はタイトルが悪い
- ✅ parttime.html はタイトル改善余地が大きい（CTR が中央値の1/10）
